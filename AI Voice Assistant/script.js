...
window.addEventListener("load", function () {
    ...
    speak('Activating ambhara');
    speak('Welcom,Dear User');
    speak('im ambhara AI voice Assistant');
    speak('Created by M Ambikhaa Devi');
    wishMe();
    speak('How can i help for you');
});
...
function speakThis(message) {
    ...
    if (message.includes('hi') || message.includes('hello') || message.includes('hii') || message.includes('hey')) {
        ...
        const finalText = 'My name is ambhara';
        speech.text = finalText;
    }

    else if (message.includes('Who are you')) {
        const finalText = 'im AI voice assistant';
        speech.text = finalText;
    }
